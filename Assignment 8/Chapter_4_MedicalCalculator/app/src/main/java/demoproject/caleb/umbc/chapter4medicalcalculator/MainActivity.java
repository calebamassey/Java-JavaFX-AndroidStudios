package demoproject.caleb.umbc.chapter4medicalcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText weight = (EditText) findViewById(R.id.editText_Input);
        final RadioButton lbToKilo = (RadioButton) findViewById(R.id.rb_Lbtokg);
        final RadioButton kiloToLB = (RadioButton) findViewById(R.id.rb_Kgtolb);
